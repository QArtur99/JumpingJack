...
public class BaseActor extends Group
{
    ...
    protected Vector2 accelerationVec2;
    ...
    public BaseActor(float x, float y, float rotation, Stage s)
    {
    ...
    /**
     *  Set world dimensions for use by methods boundToWorld() and alignCamera().
...
//        cam.position.y = MathUtils.clamp(cam.position.y, cam.viewportHeight/2, worldBounds.height - cam.viewportHeight/2);
    ...
    public static ArrayList<BaseActor> getList(Stage stage, String className)
    {
        ...
        Class theClass = null;
        try
        {  theClass = Class.forName("com.artf.jack."+className);  }
